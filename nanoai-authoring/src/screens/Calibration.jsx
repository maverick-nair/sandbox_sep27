          ...
          {cal.responses.length > 0 && (
            <div className="mt-4 overflow-x-auto">
              <table className="w-full text-xs">
                <thead><tr className="border-b border-[var(--line)] text-left"><th className="px-2 py-1.5">Response</th>{sc.scoringQuestions.map((q, i) => <th key={q.id} className="px-2 py-1.5" title={q.text}>Q{i + 1}<div className="faint font-normal">A · B · AI</div></th>)}<th /></tr></thead>
